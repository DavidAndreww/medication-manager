...
export const MedForm = ({ handleClick, handleInputChange, handleCheckboxChange, med }) => {
  ...
  return (
    <Styles.Form>
      ...
      <Styles.Input type='checkbox' name='date-sunday' value='0' checked={isActiveBox(med.frequency, '0')} onChange={(e) => handleCheckboxChange( 'frequency', e)} />
      <label htmlFor='date-sunday'>Sun</label>
      <Styles.Input type='checkbox' name='date-monday' value='1' checked={isActiveBox(med.frequency, '1')} onChange={(e) => handleCheckboxChange( 'frequency', e)} />
      <label htmlFor='date-monday'>Mon</label>
      <Styles.Input type='checkbox' name='date-tuesday' value='2' checked={isActiveBox(med.frequency, '2')} onChange={(e) => handleCheckboxChange( 'frequency', e)} />
      <label htmlFor='date-tuesday'>Tues</label>
      <Styles.Input type='checkbox' name='date-wednesday' value='3' checked={isActiveBox(med.frequency, '3')} onChange={(e) => handleCheckboxChange( 'frequency', e)} />
      <label htmlFor='date-wednesday'>Weds</label><br />
      <Styles.Input type='checkbox' name='date-thursday' value='4' checked={isActiveBox(med.frequency, '4')} onChange={(e) => handleCheckboxChange( 'frequency', e)} />
      <label htmlFor='date-thursday'>Thurs</label>
      <Styles.Input type='checkbox' name='date-friday' value='5' checked={isActiveBox(med.frequency, '5')} onChange={(e) => handleCheckboxChange( 'frequency', e)} />
      <label htmlFor='date-friday'>Fri</label>
      <Styles.Input type='checkbox' name='date-saturday' value='6' checked={isActiveBox(med.frequency, '6')} onChange={(e) => handleCheckboxChange( 'frequency', e)} />
      <label htmlFor='date-saturday'>Sat</label><br />
      <label htmlFor='daysOfWeek'>Days:</label><br />
      <Styles.Input type='checkbox' name='time-am' value='AM' checked={isActiveBox(med.time, 'AM')} onChange={(e) => handleCheckboxChange( 'time', e)}/>
      <label htmlFor='time-am'>AM</label>
      <Styles.Input type='checkbox' name='time-pm' value='PM'checked={isActiveBox(med.time, 'PM')} onChange={(e) => handleCheckboxChange('time', e)}/>
